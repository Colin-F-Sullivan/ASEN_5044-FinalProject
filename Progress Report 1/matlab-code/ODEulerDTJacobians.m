...
function [Ftilde,Gtilde,Omtilde,Htilde,Mtilde,ObservingStations]...
    = ODEulerDTJacobians(NominalStateVector, DeltaT,t)
    
    x1=NominalStateVector(1);
    x3=NominalStateVector(3);
    ...
    [Ctilde,ObservingStations] = OD_CtildeMatr(t,NominalStateVector);
